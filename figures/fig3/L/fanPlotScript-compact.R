...
df.colors.vivid[!startsWith(rownames(df.colors.vivid), 'Striatum'), 'clusters.colors'] <- gray.color

fname <- 'striatum-fan.pdf'
...
for(cl in ordered.labels){
  ...
  plot.arc(r, r+2*r/16,theta.cl[1], theta.cl[3],col = df.colors.vivid[cl,'clusters.colors'], n.points.edge = 10)
